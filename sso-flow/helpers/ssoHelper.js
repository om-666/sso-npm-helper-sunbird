...
const { getKeyCloakClient } = require('../../../helpers/keyCloakHelper')
...
const uuid = require('uuid/v1') /// have to chechk
...
const verifySignature = async (token) => { //completed
  let options = {
    method: 'GET',
    forever: true,
...
const verifyToken = (token) => { //completed
